...
#create plot
plot = sns.scatterplot(data = MG, x= 'Ba', y='Sr',hue = "Population" , palette="Blues",marker = 's', edgecolor="black", s=100,alpha = 0.5,legend="brief")
plot = sns.scatterplot(data = VCCR, x= 'Ba', y='Sr',hue = "Population", palette="PuRd", marker = '^', edgecolor="black", s=150, legend = "brief", alpha = 0.5, hue_order = ['VCCR 1', 'VCCR 2', 'VCCR 3'])
plot = sns.scatterplot(data = FG, x= 'Ba', y='Sr',hue = "Population", palette="binary_d", marker = '^', edgecolor="black", s=150, legend = "brief", alpha = 0.5, hue_order = ['FG 1', 'FG 2'], markers=('o', 's', '^', 'X'))
