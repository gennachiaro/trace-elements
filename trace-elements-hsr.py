...
#create plot
plot = sns.scatterplot(data = MG, x= 'La', y='Ti',hue = "Population" , style = MG_index, palette="Blues_d",marker = 's', edgecolor="black", s=150,alpha = 0.5, legend = "brief")
plot = sns.scatterplot(data = VCCR, x= 'La', y='Ti',hue = "Population", palette="PuRd_d", marker = '^', edgecolor="black", s=150, style = VCCR_index, alpha = 0.5, hue_order = ['VCCR 1', 'VCCR 2', 'VCCR 3'], legend = "brief")
