...
#create plot
plot = sns.scatterplot(data = FG, x= 'Ba', y='Sr', style = FG_index, hue = "Population", palette="binary_r", edgecolor="black", s=100,alpha = 0.5,legend="brief", markers=('o', 's', '^', 'X'),hue_order = ['FG 1', 'FG 2'])
