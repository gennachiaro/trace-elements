...
plot = sns.scatterplot(data = FG, x= 'Ba', y='Sr', style = "Population", hue = "Population", palette="OrRd_r", edgecolor="black", s=150,alpha = 0.5,legend=False, markers=('o', '^', 's'), hue_order = ['ORA-5B-412','ORA-5B-410', 'ORA-5B-414'])
...
plot = sns.scatterplot(data = FG, x= 'Ba', y='Y', style = "Population", hue = "Population", palette="OrRd_r", edgecolor="black", s=150,alpha = 0.5,legend="brief", markers=('o', '^', 's'), hue_order = ['ORA-5B-412','ORA-5B-410', 'ORA-5B-414'])
...
plot = sns.scatterplot(data = FG, x= 'Nb', y='Rb', style = "Population", hue = "Population", palette="OrRd_r", edgecolor="black", s=150,alpha = 0.5,legend=False, markers=('o', '^', 's'), hue_order = ['ORA-5B-412','ORA-5B-410', 'ORA-5B-414'])
