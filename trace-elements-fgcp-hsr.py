...
FGCP = df.loc[['ORA-2A-002-Type2','ORA-2A-003','ORA-2A-016-Type2','ORA-2A-023','ORA-2A-024']]
...
#create plot
plot = sns.scatterplot(data = FGCP, x= 'Ba', y='Sr', style = FGCP_index,hue = FGCP_index, palette="Greens", edgecolor="black", s=100, alpha = 0.5, legend="brief")
