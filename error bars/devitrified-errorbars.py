...
plot = sns.scatterplot(data=DEVIT, x=x, y=y, hue="Sample", palette="Reds", markers=('o','X','s'), style = "Sample",
                       edgecolor="black", s=150, legend= 'brief', alpha=0.8)
...
plot = sns.scatterplot(data=MG, x=x, y=y, hue="Sample", palette="Blues_d", markers=('o','X','s'), style = "Sample",
                       edgecolor="black", s=150, alpha=0.8, legend= 'brief')
...
#plt.legend(h, l, loc='center right', bbox_to_anchor=(0.5, 1), ncol=2, fontsize=11)
...
plot.text(10,0.12, str('error bars 1s'), fontsize = 18.5, fontweight = 'normal')
...
plt.legend(h, l, loc='lower right', bbox_to_anchor=(2, -2.15), ncol=4, handlelength = 1, columnspacing = 1, fontsize = 15, markerscale = 1.6)
