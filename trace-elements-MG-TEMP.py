...
MG = df.loc[['ORA-2A-001','ORA-2A-004','ORA-2A-005','ORA-2A-018','ORA-2A-032','ORA-2A-035','ORA-2A-036', 'ORA-2A-040']]
...
#create plot
plot = sns.scatterplot(data = MG, x= 'Sr', y='Ba', hue = MG_index , style = MG_index, palette="Blues_d",marker = 's', edgecolor="black", s=100,alpha = 0.5,legend="brief")
