...
#create plot
plot = sns.scatterplot(data = FGCP, x= 'Zr', y='Y', hue = "Population", palette="Greens", edgecolor="black", s=150, alpha = 0.5, legend=False)
plot = sns.scatterplot(data = MG, x= 'Zr', y='Y',hue = "Population" , style = MG_index, palette="Blues_d",marker = 's', edgecolor="black", s=150,alpha = 0.5,legend=False)
plot = sns.scatterplot(data = VCCR, x= 'Zr', y='Y',hue = "Population", palette="PuRd_d", marker = '^', edgecolor="black", s=150, legend = False, style = VCCR_index, alpha = 0.5, hue_order = ['VCCR 1', 'VCCR 2', 'VCCR 3'])
plot = sns.scatterplot(data = FG, x= 'Zr', y='Y', style = FG_index, hue = "Population", palette="OrRd_r", edgecolor="black", s=150,alpha = 0.5,legend=False, hue_order = ['FG 1', 'FG 2', 'FG 3'])
