...
plot = sns.scatterplot(data = FG, x= 'Zr', y='Y', style = "Population", hue = "Population", palette="OrRd_r", edgecolor="black", s=150,alpha = 0.5,legend="brief", hue_order = ['ORA-5B-412','ORA-5B-410', 'ORA-5B-414'])
