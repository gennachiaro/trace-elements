...
One = df.loc[['ORA-2A-024','MINGLED1-ORA-2A-024','MINGLED2-ORA-2A-024','MINGLED3-ORA-2A-024']]
One_index = One.index

Two = df.loc[['ORA-2A-002-Type1','ORA-2A-002-Type2','ORA-2A-002']]
Two_index = Two.index
...
#plot 1
plt.subplot(3, 1, 1)
Two = sns.scatterplot(data = Two, x= 'Ba', y='Sr', hue = Two_index, style = Two_index, palette="Greens", edgecolor="black", s=100, alpha = 0.5)
...
#plot 2
plt.subplot(3, 1, 2)
Three = sns.scatterplot(data = Three, x= 'Ba', y='Sr', hue = Three_index, style = Three_index, palette="Greens", edgecolor="black", s=100, alpha = 0.5)
...
#plot 3
plt.subplot(3, 1, 3)
One = sns.scatterplot(data = One, x= 'U', y='Zr', hue = One_index, style = One_index, palette="Greens", edgecolor="black", s=100, alpha = 0.5, legend = "brief")
