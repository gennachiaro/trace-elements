...
#create plot
plot = sns.scatterplot(data = VCCR, x= 'Ba', y='Y',hue = "Population", palette="PuRd_d", marker = '^', edgecolor="black", s=150, legend = "brief", style = VCCR_index, alpha = 0.5, hue_order = ['VCCR 1', 'VCCR 2', 'VCCR 3'])
...
# general title
plt.suptitle("Very Coarse-Grained Crystal-Rich (VCCR) Fiamme Glass", fontsize=15, fontweight=0, color='black', x = 0.6)
