...
#create ree plot
plt.subplot(1,2,1)
plot1 = sns.lineplot(data = MGREE, x= 'REE', y='Sample/Chondrite', hue = 'Population', sort = False, palette="Blues_d")
...
plot2 = sns.scatterplot(data = MG, x= 'Ba', y='Sr',hue = "Population" , style = MG_index, palette="Blues_d",marker = 's', edgecolor="black", s=100,alpha = 0.5,legend="brief")
