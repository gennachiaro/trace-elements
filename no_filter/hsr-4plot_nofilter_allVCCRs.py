...
plot2 = sns.scatterplot(data = VCCR2, x= 'Ba', y='Sr',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, style = VCCR2_index, alpha = 0.5, hue_order = ['VCCR 2', 'VCCR 3'], legend = False)
plot2 = sns.scatterplot(data = VCCR3, x= 'Ba', y='Sr',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, style = VCCR3_index, alpha = 0.5, hue_order = ['VCCR 2', 'VCCR 3'], legend = False)
...
plot = sns.scatterplot(data = VCCR2, x= 'U', y='Ti',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, legend = False, style = VCCR2_index, alpha = 0.5, hue_order = ['VCCR 2', 'VCCR 3'])
plot = sns.scatterplot(data = VCCR3, x= 'U', y='Ti',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, legend = False, style = VCCR3_index, alpha = 0.5, hue_order = ['VCCR 2', 'VCCR 3'])
...
plot = sns.scatterplot(data = VCCR2, x= 'Nb', y='Y',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, legend = False, style = VCCR2_index, alpha = 0.5, hue_order = ['VCCR 2', 'VCCR 3'])
plot = sns.scatterplot(data = VCCR3, x= 'Nb', y='Y',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, legend = False, style = VCCR3_index, alpha = 0.5, hue_order = ['VCCR 2', 'VCCR 3'])
