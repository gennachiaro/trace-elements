...
VCCR = tr.loc [['ORA-5B-404A','ORA-5B-406','ORA-5B-409','ORA-5B-411','ORA-5B-416','ORA-5B-405','ORA-5B-408-SITE7','ORA-5B-402']]
VCCR2 = tr.loc[['ORA-5B-408-SITE8']]
...
VCCRREE = REE.loc[['ORA-5B-402','ORA-5B-404A','ORA-5B-404B','ORA-5B-405','ORA-5B-406','ORA-5B-408-SITE7','ORA-5B-408-SITE8','ORA-5B-411','ORA-5B-416']]
...
plot2 = sns.scatterplot(data = VCCR2, x= 'Ba', y='Sr',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, style = VCCR2_index, alpha = 0.5, hue_order = ['VCCR 2'], legend = False)
...
plot = sns.scatterplot(data = VCCR2, x= 'U', y='Ti',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, legend = False, style = VCCR2_index, alpha = 0.5, hue_order = ['VCCR 2'])
...
plot = sns.scatterplot(data = VCCR2, x= 'Nb', y='Y',hue = "Population", palette="PuRd_r", marker = '^', edgecolor="black", s=150, legend = False, style = VCCR2_index, alpha = 0.5, hue_order = ['VCCR 2'])
