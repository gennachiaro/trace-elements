...
plot2.text(33.5,6.1, str('error bars $\pm$ 1s'), fontsize = 11, fontweight = 'normal')
...
plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/trace-elements/graphs/2A-024_4plot2.png', dpi=700)
