...
plot = sns.scatterplot(data = two, x= 'Ba', y='Sr', hue = two_index, style = two_index, palette="Blues_r", edgecolor="black", s=150, alpha = 0.5, legend='brief')
...
# general title
plt.suptitle("2A-016 + 2A-002 Comparison", fontsize=15, fontweight=0, y = 0.94)
