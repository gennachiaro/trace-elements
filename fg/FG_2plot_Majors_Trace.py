...
all_FG = df[df['Population'].isin(['ORA-5B-410', 'ORA-5B-412', 'ORA-5B-414'])]
...
df1 = df1[df1['Type'].isin(
    ['Glass'])]

df1 = df1[df1['Sample'].isin(
    ['ORA-5B-410', 'ORA-5B-412B', 'ORA-5B-414'])]
...
FG = sample_mean1[sample_mean1['Population'].isin(
    ['ORA-5B-410', 'ORA-5B-412', 'ORA-5B-414'])]
...
FG_std = sample_std1[sample_std1['Population'].isin(
    ['ORA-5B-410', 'ORA-5B-412', 'ORA-5B-414'])]
...
plot = sns.scatterplot(data = FG_All, x= x, y= y,hue = "Population", palette= "gray", edgecolor="black", marker = '^', s=150, style = "Population", alpha = 0.2, legend=False, markers=('^', 'X', 's'))
...
plot = sns.scatterplot(data=FG, x=x, y=y, hue="Population", palette="OrRd_r", style="Population", edgecolor="black",
                      s=200, legend=False, alpha=0.85, hue_order=['ORA-5B-412', 'ORA-5B-410', 'ORA-5B-414'], markers=('^', 'X', 's'))
...
plot = sns.scatterplot(data = all_FG, x= x, y=y, hue = "Population", style = "Population", palette="gray", edgecolor="black", s=150, alpha = 0.2, legend=False,  hue_order=['ORA-5B-412', 'ORA-5B-410', 'ORA-5B-414'], markers=('s', 'X', '^'))
...
plot = sns.scatterplot(data=FG1, x=x, y=y, hue="Population", palette="OrRd_r", style="Population", edgecolor="black",
                       s=200, legend='brief', alpha=0.85,  hue_order=['ORA-5B-412', 'ORA-5B-410', 'ORA-5B-414'], markers=('^', 'X', 's'))
plt.errorbar(x=FG1[x], y=FG1[y], xerr=xerr4, yerr=yerr4, ls='none',
             ecolor='orange', elinewidth=1, capsize=2, barsabove=False, alpha=0.8)
...
#plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/trace-elements/graphs/FG_majors_trace_2panel_YNb_2.svg', dpi=800)
