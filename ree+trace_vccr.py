...
#group plot title
title = fig.suptitle("Very Coarse-Grained Crystal-Rich (VCCR) Fiamme Glass", fontsize=16, y = 1.04)
...
plot2 = sns.scatterplot(data = VCCR, x= 'Ba', y='Sr',hue = "Population", palette="PuRd_d", marker = '^', edgecolor="black", s=150, legend = "brief", style = VCCR_index, alpha = 0.5, hue_order = ['VCCR 1', 'VCCR 2', 'VCCR 3'])
