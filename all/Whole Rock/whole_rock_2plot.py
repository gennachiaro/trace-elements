...
plt.legend(h[1:4] + h[5:], l[1:4] + l[5:], loc='best', ncol = 2, handlelength = 1, columnspacing = 0.5, fontsize = 11, markerscale = 1.2 ,title = "  Outflow     Intracaldera", title_fontsize = 12)
...
plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/trace-elements/graphs/whole-rock_2plot2.png', dpi=800)
