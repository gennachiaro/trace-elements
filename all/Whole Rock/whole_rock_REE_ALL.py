...
plot7 = sns.lineplot(data = FG, alpha = 0.3, linewidth = 2, zorder = 0, x= 'variable', y='value', hue = 'Sample', sort = False, palette="OrRd_r",legend="brief", hue_order = ('ORA-5B-412', 'ORA-5B-410', 'ORA-5B-414'), ci = 'sd')
...
plot6 = sns.lineplot(data = ORA_002_REE,zorder = 0, x= 'variable', y='value', hue = 'Sample', sort = False, palette="Greens_d",legend="brief", alpha = 0.5, hue_order = ('ORA-2A-002-Type 1', 'ORA-2A-002-Type 2','ORA-2A-002-Type 3'), ci = 'sd', err_kws = error_config)
plot8 = sns.lineplot(data = ORA_024_REE, zorder = 0, x= 'variable', y='value', hue = 'Sample', sort = False, palette="Greens_d",legend="brief", ci = 'sd', err_kws = error_config,  linewidth = 1, alpha = 0.5)
...
plot5 = sns.scatterplot(data = VCCR_DyYb, x= 'variable', y='value', hue = 'Population', palette="PuRd_r", hue_order = ['VCCR 2', 'VCCR 1', 'VCCR 3'], s = 100)
...
plot5 = sns.lineplot(data = VCCR_DyYb, x= 'variable', y='value', hue = 'Population', palette="PuRd_r", hue_order = ['VCCR 2','VCCR 1', 'VCCR 3'], legend = 'brief')

#h, l = plot5.get_legends_handles_labels()
#plt.legend(h[1:4],l[1:4],loc='lower left', fontsize = 15, ncol = 1, handlelength = 1.5, markerscale = 10)
...
#plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/trace-elements/graphs/vccr+fg_wholerockREE.png', dpi=800)
