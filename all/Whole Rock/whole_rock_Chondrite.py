...
plot3.text(550,35, str('Chondrite'), fontsize = 11, fontweight = 'normal')
...
#plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/trace-elements/graphs/whole-rock_4plot2.png', dpi=800)
