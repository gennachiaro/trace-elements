...
plt.legend(h[1:4] + h[5:], l[1:4] + l[5:], loc='best', ncol = 2, handlelength = 1, columnspacing = 0.5, fontsize = 15, markerscale = 1.6 ,title = "  Outflow     Intracaldera", title_fontsize = 15.5)
...
plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/trace-elements/graphs/whole-rock_4plot_Th.png', dpi=800)
