...
g = sns.swarmplot(x='T °C (WH 83)', y="Population", data=df, edgecolor = 'gray', linewidth =  0.5, ax = g, alpha = 0.7, hue = "Population", hue_order = ['CG 1', 'CG 2', 'CG 3','VCCR 1', 'VCCR 2','VCCR 3'], palette = color_dict, size = 7)
