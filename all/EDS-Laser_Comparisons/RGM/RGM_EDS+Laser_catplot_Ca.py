...
# Specify pathname
path = '/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/SEM-data/RGM_Laser_EDS_Standards_Ca.xlsx'
...
plot1 = sns.swarmplot(data=tidy, x='Method', y= 'Ca [ppm]', palette="Blues_d", hue = 'Name')
plt.legend([],[], frameon=False)
#plt.set_axis_labels("Method", "Ca [ppm]")

#plot2 = sns.catplot(data=tidy, x='Method', y= 'Value',col = 'Element', palette="Blues_d", hue = 'Name', height = 4, aspect = 0.6, legend = False)
...
plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/RGM_EDS_LAICPMS_Ca.png', dpi=500)
