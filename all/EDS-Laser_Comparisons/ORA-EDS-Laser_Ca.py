...
#values =values[values['Population'] != "CG 1"]
...
#no error bars
plt.annotate(f"$R^2: {res.rvalue**2:.3f}$", (4200, 2000))
...
#plt.savefig('/Users/gennachiaro/Documents/vanderbilt/research/ora caldera/EDS_LA-ICPMS_Ora_errorbars_Ca_NOCG1.png', dpi=500)
