...
plot = sns.scatterplot(data = devitm, x= 'SiO2', y='K2O',hue = devitm_index , style = devitm_index, marker = 's',palette="Purples_d", edgecolor="black", s=150, legend = "brief", alpha = 0.5)
...
plt.legend(h[1:7]+h[7:10]+h[11:14]+h[23:26]+h[36:45],l[1:7]+l[7:10]+l[11:14]+l[23:26]+l[36:45],loc='lower right', bbox_to_anchor=(2, -3), ncol=6, fontsize = 12)
...
plot = sns.scatterplot(data = DEVIT, x= 'Ba', y='Y', style = DEVIT_index, hue = DEVIT_index, palette="Purples_d", edgecolor="black", s=150,alpha = 0.5,legend=False, markers=('^', 'X', 's'))
...
plot = sns.scatterplot(data = DEVIT, x= 'Nb', y='Rb', style = DEVIT_index, hue = DEVIT_index, palette="Purples_d", edgecolor="black", s=150,alpha = 0.5,legend=False, markers=('^', 'X', 's'))
