...
#create plot
plot = sns.scatterplot(data = VCCR, x= 'Y', y='Nb',hue = "Population", palette="PuRd_d", marker = '^', edgecolor="black", s=150, legend = "brief", alpha = 0.5, hue_order = ['VCCR 1', 'VCCR 2', 'VCCR 3'])
